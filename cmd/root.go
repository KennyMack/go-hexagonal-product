...
import (
	"database/sql"
	dbAdapter "github.com/kennymack/go-hexagonal-product/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.go-hexagonal-product.yaml)")
